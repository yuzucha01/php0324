...
//name未入力
if(empty($name)){
    array_push($err_msgs, "料理名を入力してください");
    echo "<br>";
}
//nameは50文字以内
if(strlen($name) > 50){
    array_push($err_msgs, "料理名は50文字以内で入力してください");
    echo "<br>";
}
//zairyo未入力
if(empty($zairyo)){
    array_push($err_msgs, "材料を入力してください");
    echo "<br>";
}
//recipe未入力
if(empty($recipe)){
    array_push($err_msgs, "レシピを入力してください");
    echo "<br>";
}
