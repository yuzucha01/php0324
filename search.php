...
<body>
    ...
    <div class="content-main">
         ...
         <form action="search.php" method="post">
            ...
            <input type="submit">
            <button class="btn" type=“submit” onclick="location.href='./chat.php'">全体に戻る</button>
        </form>
        ...
        <div class="content">
            ...
            <?php foreach($searches as $search):?>
                <div class="chat-contents">
                    <img src="<?php echo "{$search['file_path']}"; ?>" alt="">
                    <p><?php echo "{$search['name']}"; ?></p>
                    <p><?php echo "{$search['zairyo']}"; ?></p>
                    <p><?php echo "{$search['recipe']}"; ?></p>
                    <p><?php echo "{$search['insert_time']}"; ?></p>
                </div>
            <?php endforeach; ?>
         </div>
